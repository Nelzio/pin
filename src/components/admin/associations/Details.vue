      ...
      >
        <q-scroll-area class="fit">
          <q-toolbar class="text-primary">
            ...
            <div class="q-gutter-sm" v-if="userData.access[1] == 'w'">
              <q-btn
                rounded
                color="primary"
                label="Editar"
                ...
                <div class="row justify-center">
                  <q-card class="col-12">
                    ...
                    <q-tab-panels v-model="tab" animated>
                      ...
                      <q-tab-panel name="description" role="tabpanel">
                        <q-list role="list">
                          <q-item class="text-left" role="listitem">
                            <q-item-section top avatar>
                              <q-icon
                            ...
                            <q-item-section>
                              <q-item-label :class="getFont.title"
                                >Tipos de deficiência</q-item-label
                              >
                              <q-item
                                class="text-left"
                                ...
                                :key="index"
                              >
                                <q-item-section :class="getFont.text">{{
                                  type
                                }}</q-item-section>
                              </q-item>
                            </q-item-section>
      ...
      >
        <q-card style="width: 700px; max-width: 80vw">
          ...
          <q-card-section :class="getFont.text"
            >Remover associação {{ association.name }}?</q-card-section
          >
