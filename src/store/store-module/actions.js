...
export function createStore ({ commit }, payload) { // done
...
export function updateStore ({ commit, dispatch }, payload) {
    if (!offline.data().isOnline) {
        return showErrorMessage("Está sem internet.")
    }
    Loading.show()
...
export function listStore ({ commit }) { // done
    var storageRef = fireStorage.ref()
    if (!offline.data().isOnline) {
...
export function listStoreMy ({ commit }, user) { // done
    var storageRef = fireStorage.ref()
    if (!offline.data().isOnline) {
        showErrorMessage("Está sem internet.")
    }
...
export function detailStore ({ commit }, id) { // test
    // Loading.show()
...
export function deleteStore ({ commit }, id) {
    Loading.show()
