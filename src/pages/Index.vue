      ...
      >
        <q-card-section horizontal>
          <q-card-section class="q-pt-xs">
            ...
            >Vagas de emprego</div>
            <div :class="getFont.text">Publique e encontre vagas de emprego na plataforma. A plataforma é inclusiva, no sentido de que todos pode usar de igual forma, sendo assim, todos os utilizadores da plataforma podem publicar vagas de emprego e se candidatar a uma delas. Tanto pessoas singulares como colectivas.</div>
          </q-card-section>
        ...
        <q-card-section horizontal>
          ...
          <q-card-section class="q-pt-xs">
            <div
              ...
              class="q-mt-sm q-mb-xs"
            >Negócio</div>
            <div :class="getFont.text">Exponha os seus produtos e serviços e também encontre produtos e serviços de outros utilizadores da plataforma. Alcance mais facil os seu clientes e encontre rápido o que deseja.</div>
          </q-card-section>
        </q-card-section>
      </q-card>
      <q-card
        ...
        <q-card-section horizontal>
          <q-card-section class="q-pt-xs">
            <div
              ...
              class="q-mt-sm q-mb-xs"
            >Inclusão</div>
            <div :class="getFont.text">A plataforma é inclusiva e tem recurso de acessibilidade indispensável. Pessoas com e sem deficiência podem usar a plataforma de igual forma, assim todos interagem e as diferenças são eliminadas.</div>
          </q-card-section>
          <q-card-section class="col-5 flex flex-center">
            <q-img
              class="rounded-borders"
