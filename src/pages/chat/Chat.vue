<template>
  ...
  >
    ...
    <q-footer v-if="!$q.screen.gt.sm" role="none">
      <q-toolbar
        class="row"
      ...
      >
        ...
        >
          <div
            class="row"
            :class="[
              darkModeConf.bgColor,
              darkModeConf.textColor,
              getFont.text,
            ]"
          >
            <q-input
    ...
    <q-page-sticky position="bottom" v-if="$q.screen.gt.sm" role="group">
      <q-toolbar
        class="bg-grey-3 row"
        :class="[darkModeConf.bgColor, darkModeConf.textColor]"
        style="width: 50vw"
  ...
  methods: {
    ...
    getChat() {
      ...
      const ref = firestoreDB
        .collection("chat")
        .doc(this.idReceptor.split("@")[0])
        .collection(this.user.email.split("@")[0])
      var chatData = []
      var chatDataObj = {}
      // const
    ...
    getChatToRead() {
      ...
      const ref = firestoreDB
        ...
        .collection(this.idReceptor.split("@")[0])
      var chatDataObj = {}
    ...
    uploadFile(file) {
      ...
      var resultAudioName =
        ...
        Math.random().toString(36).substring(2, 15)
      var audioName =
        vm.user.displayName.split(" ")[0] + resultAudioName + ".mp3"
